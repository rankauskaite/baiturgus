            ...
            <div className='mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8'>
                ...
                <div className='mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16'>
                    <div className={cn('lg:col-span-7', {
                        'rounded-lg border-2 border-dashed border-pink-200 p-12': isMounted && items.length === 0
                    })}>
                        ...
                        <ul className={cn({
                            'divide-y divide-pink-200 border-b border-t border-pink-200': isMounted && items.length > 0
                        })}>
                            {isMounted && items.map(({product}) => {
                                const label = PRODUCT_CATEGORIES.find((cat) => cat.value === product.category)?.label
                    ...
                    <section className='mt-16 rounded-lg bg-pink-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8'>
                        ...
                        <div className='mt-6'>
                            <Button disabled={items.length === 0 || isLoading} onClick={() => createCheckoutSession({productIds})} className='w-full' size='lg'>
                                {isLoading ? (
                                    <Loader2 className='w-4 h-4 animate-spin mr-1.5 text-pink-400' />
                                ) : null}
                                Checkout
                            </Button>
                        </div>
