                    ...
                    <div className='lg:col-start-2'>
                        ...
                        {order._isPaid ? (
                            <p className='mt-2 text-base text-muted-foreground'>
                                Your order was processed and Your assets are awailable to download below.
                            ...
                            <p className='mt-2 text-base text-muted-foreground'>
                                ...
                                So hang tight and we will send You confirmation very soon!
                            </p>
                        )}
                        ...
                        <div className='mt-16 text-sm font-medium'>
                            ...
                            <ul className='mt-6 divide-y divide-pink-200 border-t border-pink-200 text-sm font-medium text-muted-foreground'>
                                        ...
                                        <li key={product.id} className='flex space-x-6 py-6'>
                                            <div className='relative h-24 w-24'>
                                                {typeof image !== "string" && image.url ? (
                                                    <Image fill src={image.url} alt={`${product.name} image`} className='flex-none rounded-md bg-pink-100 object-cover object-center' />
                                                ) : null}
                                            </div>
                                            ...
                                            <div className='flex-auto flex flex-col justify-between'>
                                                ...
                                                {order._isPaid ? (
                                                    <a href={downloadUrl} download={product.name} className='text-pink-600 hover:underline underline-offset-2'>
                                                        Download asset
                                                    </a>
                                                ) : null}
                                            </div>
                            ...
                            <div className='space-y-6 border-t border-pink-200 pt-6 text-sm font-medium text-muted-foreground'>
                                ...
                                <div className='flex items-center justify-between border-t border-pink-200 pt-6 text-gray-900'>
                            ...
                            <div className='mt-16 border-t border-pink-200 py-6 text-right'>
