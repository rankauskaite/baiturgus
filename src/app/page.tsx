...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description: "Every asset on our pletform is verified by our team to ensure highest quality standards. Not happy? We offer a 30-day refund guarantee.",
  },
  {
    name: "For the Planet",
    Icon: Leaf,
  ...
  return (
    ...
    <MaxWidthWrapper>
      <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
        ...
        <p className='mt-6 text-lg max-w-prose text-muted-foreground'>
          Welcome to BaiTurgus. Every asset on our
    ...
    <section className='border-t border-pink-200 bg-pink-50'>
      <MaxWidthWrapper className='py-20'>
        {/* sm: small devices like mobile phone, lg: large devices like computer md: medium devices */}
